...
function el(element, attrs) {
    ...
    if (element && element.isComponent) {
        ...
        var allChildren = (0, _util.flatten)(children).map(function (child) {
            return child.simpleDomChildren || [];
        });
        var simpleDomChildren = (0, _util.flatten)(allChildren).concat(children).filter(function (comp) {
            return comp.isComponent;
        });
        var i = 0;
        return {
            ...
            children: ((0, _util.flatten)(children) || []).filter(function (child) {
                ...
                if (child.isReactComponent) {
                    return _react2.default.createElement(child.componentClass, child.attrs, child.children);
                } else if (child.isComponent) {
                    var newElem = _react2.default.createElement('div', { 'data-attribute': i }, []);
                    ++i;
                    return newElem;
                }
                return _react2.default.createElement(child.name, child.attrs, child.children);
            }).filter(function (child) {
                return child !== null && child !== undefined;
            }),
            simpleDomChildren: simpleDomChildren
        };
    } else {
